...
const Background = () => (
    <div className='wrap1'>
      ...
      <video className="backgrounddevice" src="https://ik.imagekit.io/7ol7k87qcca/Boia/backgrounddevice_1sB3fQ5An.m4v" type="video/mp4" autoPlay loop muted playsInline ></video>
