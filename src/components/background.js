...
const Background = () => (
    <div className='wrap1'>
      ...
      <video className="backgrounddevice" src="https://ik.imagekit.io/7ol7k87qcca/Boia/test_pJhGvORHpid5A.mp4" type="video/mp4" autoPlay loop muted playsInline ></video>
