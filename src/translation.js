export const resources = {
  en: {
    translation: {
      ...
      card4 : "TEST1PROD videoclip showreel - This is a resume of some music videos I shot between 2017 and 2019; during these years I shot more than 30 music videos from independent artists. All the videos were shot, directed and edited by myself under the pseudonym of Test1Prod.",
  ...
  it: {
    translation: {
      ...
      card1 : "LO STRUMENTO DELLA FAMA - Ludovico Nenni è un attore trentenne che vive nello stesso teatro in cui lavora. Stanco di una situazione così instabile, accetta di fare un provino particolare in un luogo nascosto con persone eccentriche. Il provino consiste in un “test di fama” in cui il candidato deve proiettarsi su una realtà virtuale e affrontare lo stress di essere una superstar. Il provino lascerà a Ludovico un segno particolare anche a distanza di diversi mesi dalla sua fine, tanto che dovrà decidere quali valori deve abbandonare per diventare quello che vuole essere: un vero attore o solo una superstar?",

      card2 : "POVERI E INFAMI - Questa è la storia di Jimmy, un uomo che vive come un ribelle e rifiuta ogni valore che la società gli offre. Vive col mito di Jim Morrison, personaggio del quale cerca di seguire il suo stile di vita basato su una perdizione totale.",

      card3 : "PERCHE' NON SA VOLER BENE - Diego è un ragazzo distratto che fa il fattorino per la pizzeria di suo zio. L’incontro casuale-imbarazzante con una prostituta dell’est rende Diego sempre più curioso del mistero che avvolge la ragazza. Proverà a incontrarla di nuovo fino a quando non deciderà di aiutare la ragazza a vivere una vita migliore.",

      card4 : "TEST1PROD videoclip showreel - Un mix di videoclip che ho girato tra il 2017 e il 2019; ho girato in totale più di 30 videoclip di vari artisti indipendenti e auto prodotti. Tutti i video sono stati ideati, girato e montati con lo pseudonimo di Test1Prod.",
